...
final public class DrinkEntity: MenuOptionEntity, CDEntityToModelConverter {
    typealias T = DrinkModel
    
    func convert() -> DrinkModel {
    ...
    static func initialize(context moc: NSManagedObjectContext, with model: DrinkModel) -> Self {
